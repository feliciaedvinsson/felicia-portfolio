  ...
  return (
    <div className="min-h-screen py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-sm uppercase tracking-wider text-primary font-medium mb-2">{project.category}</p>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {project.tools.map((tool) => (
              <span key={tool} className="text-sm px-4 py-2 rounded-full bg-secondary text-secondary-foreground">
                {tool}
              </span>
            ))}
          </div>
