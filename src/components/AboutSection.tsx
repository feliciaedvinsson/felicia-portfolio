      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-end">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative w-72 md:w-80 rounded-2xl overflow-hidden shadow-lg">
              <img src={feliciaImg} alt="Felicia Edvinsson" className="w-full h-auto object-cover grayscale contrast-110" />
