  ...
  return (
    <section
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto animate-fade-in">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto mb-10 leading-relaxed">En kreativ digital designer med passion för UI-design och grafisk formgivning. Utforska min portfolio och se hur design kan göra skillnad! 
